...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public void importEmployees() throws JAXBException, FileNotFoundException {
        final String xml = Paths.EMPLOYEES_XML_PATH.toAbsolutePath().toString();

        final EmployeeRootDto employeeRootDto = xmlParser.convertFromFile(xml, EmployeeRootDto.class);
